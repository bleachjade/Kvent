...
*** Test Cases ***
Test user login succeed via Django auth, create and delete the event.
...
Check that create event succeed
    ...
    Sleep   2s
Delete the event 
    Click Link    xpath:/html/body/section/div/div[3]/div[1]/div/a
    Wait Until Page Contains     ${EVENT-NAME}
    Sleep   2s
    Click Link    xpath:/html/body/div/div[2]/a
    Sleep    2s
    Wait Until Page Contains    You've deleted
